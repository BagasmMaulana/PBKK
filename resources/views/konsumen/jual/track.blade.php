...
@section('content')
<div class="container">
<h1 style="text-align: center;">Melacak</h1>
...
<table class="table">
 ...
 <tr>
    <td>Nama</td>
    <td>{{ $alamat_kirim ? $alamat_kirim->nama_penerima : 'Bagas Akbar Maulana' }}</td>
</tr>
 </tbody>
</table>
<h2>Order</h2>
...
Carbon\Carbon::parse($jual->waktu_siap)->diffForHumans(Carbon\Carbon::parse($jual->waktu_pesan)).')' : '' }}
</td></tr>
